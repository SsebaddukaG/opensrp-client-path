...
public class Hia2IndicatorsTest {
    ...
    public void ch1005(){
        ...
        assertIndicator(HIA2Service.CHN1_005);
    }

    @Test
    public void ch1010(){

        assertIndicator(HIA2Service.CHN1_010);
    }

    @Test
    public void ch1011(){

        assertIndicator(HIA2Service.CHN1_011);
    }

    @Test
    public void ch1015(){

        assertIndicator(HIA2Service.CHN1_015);
    }

    @Test
    public void ch1020(){

        assertIndicator(HIA2Service.CHN1_020);
    }

    @Test
    public void ch1021(){

        assertIndicator(HIA2Service.CHN1_021);
    }

    @Test
    public void ch1025(){

        assertIndicator(HIA2Service.CHN1_025);
    }

    @Test
    public void ch1030(){

        assertIndicator(HIA2Service.CHN1_030);
    }
